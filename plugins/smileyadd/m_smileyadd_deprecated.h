...
#define SMADD_SHOWSEL_SIZE_V1    (offsetof(SMADD_SHOWSEL3, hwndParent))
#define SMADD_SHOWSEL_SIZE_V2    (offsetof(SMADD_SHOWSEL3, hContact))

#define SMADD_RICHEDIT_SIZE_V1   (offsetof(SMADD_RICHEDIT3, flags))
#define SMADD_RICHEDIT_SIZE_V2   (offsetof(SMADD_RICHEDIT3, hContact))

#define SMADD_INFO_SIZE_V1       (offsetof(SMADD_INFO2, hContact))

#define SMADD_BATCHPARSE_SIZE_V1 (offsetof(SMADD_BATCHPARSE2, hContact))
