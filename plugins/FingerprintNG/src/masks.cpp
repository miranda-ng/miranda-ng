...
//###########################################################################################################################################################################################################
	...
	{"client_Python",			_T("|Py*-t*|Py???t*|*Python*"),				_T("Python transport clients"),			_T("ClientIcons_multiproto"),	IDI_PYTHON,				MULTI_CASE	},
...
//###########################################################################################################################################################################################################
	...
	{"client_Aqq",				_T("|http://aqq.eu*|aqq*"),					_T("Aqq"),								_T("ClientIcons_Jabber"),		IDI_AQQ,				JABBER_CASE,	TRUE	},
	...
	{"client_Glu",				_T("|*glu*|http://glu.net/*"),				_T("Glu"),								_T("ClientIcons_Jabber"),		IDI_GLU,				JABBER_CASE,	TRUE	},
	...
	{"client_Smack",			_T("|*igniterealtime.org/*smack*|*smack*"),	_T("Smack"),							_T("ClientIcons_Jabber"),		IDI_SMACK,				JABBER_CASE,	TRUE	},
	...
	{"client_Teabot",			_T("|*teabot*|*teabot.org/bot*|bot"),		_T("Teabot"),							_T("ClientIcons_Jabber"),		IDI_TEABOT,				JABBER_CASE,	TRUE	},
	...
	{"client_jabberDisk",		_T("|*jdisk*|*jabberDisk*"),				_T("jabberDisk"),						_T("ClientIcons_Jabber"),		IDI_JABBER_DISK,		JABBER_CASE,	TRUE	},
	...
	{"client_pjc",				_T("|*PJC*|http://pjc.googlecode.com/*"),	_T("PHP Jabber Client"),				_T("ClientIcons_Jabber"),		IDI_PJC,				JABBER_CASE,	TRUE	},
...
//#################################		PROTO OVERLAYS		#################################################################################################################################################
//###########################################################################################################################################################################################################
	{"client_AIM_overlay",		_T("*AIM*"),								_T("AIM overlay"),						_T("ClientIcons_overlays"),		IDI_AIM_OVERLAY,		OVERLAYS_PROTO_CASE	},	//FIX
...
//###########################################################################################################################################################################################################
	...
	{"client_Yahoo11",			_T("*Yahoo 11*"),							_T("Yahoo v11.x overlay"),				_T("ClientIcons_Yahoo"),		IDI_YAHOO11_OVERLAY,	YAHOO_CASE	},
	{"client_Yahoo10",			_T("*Yahoo 10*"),							_T("Yahoo v10.x overlay"),				_T("ClientIcons_Yahoo"),		IDI_YAHOO10_OVERLAY,	YAHOO_CASE	},
	{"client_Yahoo9",			_T("*Yahoo 9*"),							_T("Yahoo v9.x overlay"),				_T("ClientIcons_Yahoo"),		IDI_YAHOO9_OVERLAY,		YAHOO_CASE	},
...
{//	IconName						Mask										Icon caption							 NULL ICON_RESOURCE_ID
	...
	{"client_work_overlay",		_T("|*[*work*]*|*[*работа*]*|*wkr*"),		_T("[Work]"),							_T("ClientIcons_overlays"),		IDI_WORK_OVERLAY,		OVERLAYS_RESOURCE_CASE	},
	{"client_office_overlay",	_T("|*[*office*]*|*[*офис*]*"),				_T("[Office]"),							_T("ClientIcons_overlays"),		IDI_OFFICE_OVERLAY,		OVERLAYS_RESOURCE_CASE	},
	...
	{"client_note_overlay",		_T("|*[*note*]*|*[*laptop*]*|*[*usb*]*")
								_T("|*[*кирпич*]*|*[*portable*]*|"),		_T("notebook overlay"),					_T("ClientIcons_overlays"),		IDI_NOTEBOOK_OVERLAY,	OVERLAYS_RESOURCE_CASE	},
