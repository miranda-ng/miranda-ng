...
extern int CALLBACK WordBreakProc(LPTSTR text, int current, int max, int action);
	...
	case WM_INITDIALOG:
		{
			...
			SendDlgItemMessage(hwndDlg, IDC_CHAT_MESSAGE, EM_SETWORDBREAKPROC, 0, (LPARAM)(EDITWORDBREAKPROC) WordBreakProc);
