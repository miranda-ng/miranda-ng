...
function ParseRCFile(FileTextVar,array) {
 ...
 while ((string = find.exec(FileTextVar)) != null) {
      ...
      onestring=string[2].replace(/^(((List|Tab|Tree|Spin|Custom|Slider|DateTimePicker|Radio|Check|HotKey|Progress)\d)|(whiterect|IndSndList|&?[Oo][Kk]|Google|ICQ|Jabber|Miranda|Miranda NG|OSD|SMS|Twitter|WhatsApp|Windows|&\w)|(%.(.*%)?))$/g,"");
...
var filter1=/^(&?[Oo][Kk]|Google|ICQ|Jabber|Miranda|Miranda NG|OSD|SMS|Twitter|WhatsApp|Windows)$/g;
