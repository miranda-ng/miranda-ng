...
function ParseRCFile(FileTextVar,array) {
 ...
 while ((string = find.exec(FileTextVar)) != null) {
      ...
      onestring=string[2].replace(/^(((List|Tab|Tree|Spin|Custom|Slider|DateTimePicker|Radio|Check|HotKey|Progress)\d)|(whiterect|IndSndList|&?[Oo][Kk]|AOL|Bing|CTCP|DCC|Google|GPG|ICQ|ID|IP|iTunes|Jabber|JID|Miranda|Miranda NG|mRadio|MSN|OSD|OTR|PGP|SMS|SSL|Tlen|Tox|Twitter|Yahoo|WhatsApp|Winamp \(\*\)|Windows|&\w)|(%.(.*%)?))$/g,"");
...
var filter1=/^(&?[Oo][Kk]|AOL|Bing|CTCP|DCC|Google|GPG|ICQ|ID|IP|iTunes|Jabber|JID|Miranda|Miranda NG|mRadio|MSN|OSD|OTR|PGP|SMS|SSL|Tlen|Tox|Twitter|Yahoo|WhatsApp|Winamp \(\*\)|Windows)$/g;
