...
function ParseRCFile(FileTextVar,array) {
 ...
 while ((string = find.exec(FileTextVar)) != null) {
      ...
      onestring=string[2].replace(/^(((List|Tab|Tree|Spin|Custom|Slider|DateTimePicker|Radio|Check|HotKey|Progress)\d)|(whiterect|IndSndList|&?[Oo][Kk]|AOL|Bing|Google|GPG|ICQ|IP|Jabber|Miranda|Miranda NG|MSN|OSD|PGP|SMS|SSL|Tlen|Tox|Twitter|Yahoo|WhatsApp|Windows|&\w)|(%.(.*%)?))$/g,"");
...
var filter1=/^(&?[Oo][Kk]|AOL|Bing|Google|GPG|ICQ|IP|Jabber|Miranda|Miranda NG|MSN|OSD|PGP|SMS|SSL|Tlen|Tox|Twitter|Yahoo|WhatsApp|Windows)$/g;
