...
function ParseRCFile(FileTextVar,array) {
 ...
 while ((string = find.exec(FileTextVar)) != null) {
      ...
      onestring=string[2].replace(/^(((List|Tab|Tree|Spin|Custom|Slider|DateTimePicker|Radio|Check|HotKey|Progress)\d)|(whiterect|IndSndList|&?[Oo][Kk]|AOL|APOP|BBS|Bing|CTCP|DCC|Foodnetwork|Google|GPG|Hotmail|ICQ|ICQ Corp|ID|IP|ISDN|iTunes|Jabber|JID|Miranda|MirandaG15|Miranda NG|mRadio|MSN|NickServ|OSD|OTR|PCS|PGP|SMS|SSL|SteamID|Steam Guard|Tlen|Tox|Twitter|Yahoo|WhatsApp|Winamp \(\*\)|Windows|X400|&\w)|(%.(.*%)?))$/g,"");
