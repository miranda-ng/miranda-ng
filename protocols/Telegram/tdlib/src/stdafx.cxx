...
std::int32_t used_ids[] = {
	...
	td::td_api::cancelPreliminaryUploadFile::ID,
	...
	td::td_api::fileTypeAudio::ID,
	td::td_api::fileTypeDocument::ID,
	td::td_api::fileTypePhoto::ID,
	td::td_api::fileTypeVideo::ID,
	...
	td::td_api::inputFileId::ID,
	td::td_api::inputFileLocal::ID,
	td::td_api::inputFileRemote::ID,
