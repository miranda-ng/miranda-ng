...
namespace proto
{
	...
	C##T* p; \
	public: \
	T(const MBinBuffer &buf) : p((C##T*)protobuf_c_message_unpack(&D, 0, buf.length(), buf.data())) {} \
	T(const ProtobufCBinaryData &data) : p((C##T*)protobuf_c_message_unpack(&D, 0, data.len, data.data)) {} \
