...
CXX      := g++
CC       := gcc
CXXFLAGS :=  -g $(shell  pkg-config --cflags --libs gtk4)  -fPIC $(Preprocessors)
CFLAGS   :=  -g $(shell  pkg-config --cflags --libs gtk4 )  -fPIC $(Preprocessors)
ASFLAGS  := 
AS       := as
...
$(IntermediateDirectory)/src_Linux_CCtrlCheck.cpp$(PreprocessSuffix): src/Linux/CCtrlCheck.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_Linux_CCtrlCheck.cpp$(PreprocessSuffix) src/Linux/CCtrlCheck.cpp
...
$(IntermediateDirectory)/src_Linux_CCtrlCombo.cpp$(ObjectSuffix): src/Linux/CCtrlCombo.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/ghazan/miranda-ng/src/mir_core/src/Linux/CCtrlCombo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Linux_CCtrlCombo.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_Linux_CCtrlCombo.cpp$(PreprocessSuffix): src/Linux/CCtrlCombo.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_Linux_CCtrlCombo.cpp$(PreprocessSuffix) src/Linux/CCtrlCombo.cpp
...
$(IntermediateDirectory)/src_Linux_CCtrlData.cpp$(PreprocessSuffix): src/Linux/CCtrlData.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_Linux_CCtrlData.cpp$(PreprocessSuffix) src/Linux/CCtrlData.cpp
...
$(IntermediateDirectory)/src_Linux_CCtrlButton.cpp$(PreprocessSuffix): src/Linux/CCtrlButton.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_Linux_CCtrlButton.cpp$(PreprocessSuffix) src/Linux/CCtrlButton.cpp
