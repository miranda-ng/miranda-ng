...
static FontOptionsList fontOptionsList[] =
{
	...
	{ LPGENW("Incoming messages"),            RGB(90, 90, 90),    lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -12 },
	{ LPGENW("Outgoing messages"),            RGB(90, 90, 90),    lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -12 },
	...
	{ LPGENW("Action messages"),              RGB(160, 90, 160),  lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -12 },
	{ LPGENW("Highlighted messages"),         RGB(180, 150, 80),  lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -12 },
